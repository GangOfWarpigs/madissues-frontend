...
<template>
    <article class="flex w-full px-8 py-5 bg-gray-100 rounded-lg mt-5 text-slate-600 cursor-pointer hover:shadow-lg hover:shadow-gray-200">
        <b-icon-record-circle class="text-green-500 text-2xl mr-6"/>
