...
<template>
    <div class="w-full flex flex-col">
        ...
        <div class="flex items-center justify-between px-2 text-gray-400 text-sm font-normal">
            ...
            <div class="flex items-center">
                <div class="flex items-center mr-5 cursor-pointer select-none" @click="handlePriorityChange('title')">
                    <p class="mr-1">Title</p>
                    <b-icon-caret-down-fill class="text-xs" v-if="!orderPriority.includes('title')"></b-icon-caret-down-fill>
                    <b-icon-caret-up-fill class="text-xs" v-if="orderPriority.includes('title')"></b-icon-caret-up-fill>
                </div>
                <div class="flex items-center mr-5 cursor-pointer select-none" @click="handlePriorityChange('course')">
                  <p class="mr-1">Subject</p>
                  <b-icon-caret-down-fill class="text-xs" v-if="!orderPriority.includes('course')"></b-icon-caret-down-fill>
                  <b-icon-caret-up-fill class="text-xs" v-if="orderPriority.includes('course')"></b-icon-caret-up-fill>
                </div>
                <div class="flex items-center cursor-pointer select-none" @click="handlePriorityChange('status')">
                    <p class="mr-1">Status</p>
                    <b-icon-caret-down-fill class="text-xs" v-if="!orderPriority.includes('status')"></b-icon-caret-down-fill>
                    <b-icon-caret-up-fill class="text-xs" v-if="orderPriority.includes('status')"></b-icon-caret-up-fill>
                </div>
            </div>
        </div>
