...
<template>
  <div class="flex flex-row drop-shadow-2xl justify-center items-center ">
    ...
    <button class="bg-white border-2 border-[#978EFF] text-[#978EFF] px-3 py-1 rounded-md">Ask us</button>
  </div>
</template>
