...
<template>
  <nav class="w-full text-gray-400 text-lg my-4 font-normal">
    <ul class="flex border-b-2 border-gray-200 gap-8">
        ...
        <router-link class="text-center" active-class="font-semibold pb-1.5 text-blue-500 border-b-2 border-blue-500" :to="{ path: basePath + 'profile/issues' }" replace>Issues</router-link>
        <router-link class="text-center" active-class="font-semibold pb-1.5 text-blue-500 border-b-2 border-blue-500" :to="{ path: basePath + 'profile/faqs' }" replace>Faqs</router-link>
    </ul>
  </nav>
</template>