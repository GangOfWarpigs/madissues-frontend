...
<template>
    <article class="w-full flex flex-col text-slate-600">
        <div class="flex items-center text-lg mb-3" :class="color">
            <b-icon-record-circle :class="[ status === 'Queued' ? 'block' : 'hidden']"/>
            <b-icon-arrow-right-circle :class="[ status === 'In progress' ? 'block' : 'hidden']"/>
            <b-icon-check-circle :class="[ status === 'Solved' ? 'block' : 'hidden']"/>
            <b-icon-x-circle :class="[ status === 'Not solved' ? 'block' : 'hidden']"/>
